...
This appendix provides the detailed proofs regarding monotone calling strategies and their role in equilibrium selection in LCP.
...
% \subsection{Monotone-Admissibility and Equilibrium Selection}
...
% If the caller violates this condition by calling less aggressively against smaller bets, the bettor can exploit this by taking smaller risks for higher returns. A monotone calling strategy is therefore less exploitable. Imposing this condition restricts the strategy space in a way that selects a Nash equilibrium with desirable properties.
